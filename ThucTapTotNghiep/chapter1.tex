	...
	\begin{flushleft}
		...
		LUNA NEXUS VN INC. cung cấp một môi trường làm việc chuyên nghiệp, thân thiện và sáng tạo, giúp thực tập sinh cảm thấy thoải mái và phát huy tối đa khả năng của mình.

		\subsubsection*{4. Cơ Hội Phát Triển Nghề Nghiệp}
		Thực tập sinh có cơ hội phát triển nghề nghiệp tại LUNA NEXUS VN INC. Nếu thể hiện tốt trong quá trình thực tập, họ có thể được xem xét cho các vị trí chính thức sau khi kết thúc thời gian thực tập.
